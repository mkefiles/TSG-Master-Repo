-- THE FOLLOWING COMMANDS ARE ALL SINGLE-RUN COMMANDS TO POPULATE THE DATABASE

/**
* Create the database
* - Command is grayed out because I ran it manually in the shell
*/
-- CREATE DATABASE healthcare_site;

/**
* Create a User with Permissions
* - Command is grayed out because I ran it manually in the shell
*/
-- CREATE USER mkefiles WITH PASSWORD 'mike0131';
-- GRANT ALL PRIVILEGES ON DATABASE healthcare_site TO mkefiles;
...
/**
* Add values to applicable tables
*/
...
VALUES
    (
        '1001',
        'Health Options - Clear Choice - Bronze',
        473.80,
        7500.00,
        20
    ),
